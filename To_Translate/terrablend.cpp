...
*/
TerraBlend::TerraBlend(QVector<TerraNode*> v) :TerraOperator(v)
{
}
...
*/
TerraBlend::TerraBlend(TerraNode* a, TerraNode* b, TerraNode* c, TerraNode* d) :TerraOperator(a, b, c, d)
{
}
...
*/
void TerraBlend::Draw(QGraphicsScene& gs) const
{
  for (int i = 0; i < nodes.size(); i++)
  {
    nodes.at(i)->Draw(gs);
...
*/
void TerraBlend::writeJson(QJsonObject& json) {
